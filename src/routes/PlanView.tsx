    ...
    <div className="relative h-full w-full overflow-hidden">
      ...
      <div className="absolute bottom-4 right-4 z-20 flex items-center gap-3">
        ...
        <button
          ...
          className="flex items-center justify-center w-14 h-14 rounded-full bg-brand text-white shadow-lg hover:bg-brand-hover disabled:opacity-40 disabled:cursor-not-allowed transition-all duration-150"
