    ...
    <div className="relative h-full w-full overflow-hidden">
      ...
      <div className="absolute top-4 left-1/2 -translate-x-1/2 z-20">
        <input
          ...
          className="bg-transparent border border-transparent rounded-2xl px-5 py-2 text-center text-lg font-bold text-slate-800 tracking-tight placeholder:text-slate-400 placeholder:font-normal focus:outline-none focus:bg-white/90 focus:backdrop-blur-md focus:shadow-lg focus:border-slate-200/60 focus:ring-2 focus:ring-brand/40 transition-all duration-150 min-w-[200px] max-w-[400px]"
